	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/tp/area/tpArea/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
		   ...
		   <tbody>
				<tr>
					...
					<td class="width-35">
						...
						title="上级主键" url="/tp/area/tpArea/treeData" extId="${tpArea.id}" cssClass="form-control " allowClear="true"/>
					</td>
