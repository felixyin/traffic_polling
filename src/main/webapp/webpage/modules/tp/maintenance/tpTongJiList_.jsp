...
<script>
    $(document).ready(function () {
        ...
        $tpMaintenanceTable.bootstrapTable({
            ...
            url: "${ctx}/tp/maintenance/tpMaintenance/tongJidata",
            ...
            columns: [
                ...
                , {
                    ...
                    sortName: 'unit',
                    formatter: function (value, row, index) {
                        return jp.getDictLabel(${fns:toJson(fns:getDictList('material_unit'))}, value, "-");
                    }
                }
                , {
                    field: 'allCount',
        ...
        $("#export").click(function () {//导出Excel文件
            ...
            jp.downloadFile('${ctx}/tp/maintenance/tpMaintenance/exportReport?' + values);
            setTimeout(function () {
