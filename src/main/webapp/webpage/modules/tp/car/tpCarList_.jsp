        ...
        $('#tpCarTable').bootstrapTable({
            ...
            columns: [{
                ...
                , {
                    ...
                    title: '装机时总里程',
                    sortable: true,
                    sortName: 'startKm', formatter: function (value, row, index) {
                ...
                , {
                    ...
                    title: 'GPS总里程',
                    sortable: true,
                    sortName: 'sumKm', formatter: function (value, row, index) {
                        return value ? value + '公里' : '';
                    }
                ...
                , {
                    ...
                    title: '当前预计总里程',
                    sortable: true,
                    sortName: 'currentKm', formatter: function (value, row, index) {
                        if (row.startKm) {
                            return (row.startKm + row.sumKm) + '公里';
                        } else {
                            return '';
                        }
                    }
