...
<head>
	...
	<%@include file="tpMaintenanceList.js" %>
</head>
<body>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="tpMaintenance" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="施工开始时间：">&nbsp;施工开始时间：</label>
					<div class="col-xs-12">
						   <div class="col-xs-12 col-sm-5">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="施工结束时间：">&nbsp;施工结束时间：</label>
					<div class="col-xs-12">
						   <div class="col-xs-12 col-sm-5">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="tp:maintenance:tpMaintenance:add">
			...
			<shiro:hasPermission name="tp:maintenance:tpMaintenance:import">
