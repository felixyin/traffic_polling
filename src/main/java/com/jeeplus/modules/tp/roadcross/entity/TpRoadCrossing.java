...
public class TpRoadCrossing extends DataEntity<TpRoadCrossing> {
    ...
    @ExcelField(title = "道路1", fieldType = TpRoad.class, value = "tpRoad1.name", align = 2, sort = 6)
    ...
    @ExcelField(title = "道路2", fieldType = TpRoad.class, value = "tpRoad2.name", align = 2, sort = 7)
    ...
    @ExcelField(title = "道路3", fieldType = TpRoad.class, value = "tpRoad3.name", align = 2, sort = 8)
    ...
    @ExcelField(title = "道路4", fieldType = TpRoad.class, value = "tpRoad4.name", align = 2, sort = 9)
    ...
    @ExcelField(title = "道路5", fieldType = TpRoad.class, value = "tpRoad5.name", align = 2, sort = 10)
    ...
    @ExcelField(title = "道路6", fieldType = TpRoad.class, value = "tpRoad6.name", align = 2, sort = 11)
